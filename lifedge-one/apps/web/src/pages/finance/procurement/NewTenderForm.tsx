  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] max-w-2xl mx-auto text-center space-y-6">
        ...
        <h2 className="text-3xl font-serif font-medium text-foreground tracking-tight">Tender Statutory Clearance Issued</h2>
        <p className="text-muted leading-relaxed">
          Your IFB has been validated against the MFDP Annual Budget and synchronized with the PPCC e-Portal for public competition.
        </p>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-muted">Procuring Entity (MAC)</label>
                    <select 
                      value={entity}
                      onChange={(e) => setEntity(e.target.value)}
                      className="w-full bg-background border border-border rounded-xl px-5 py-4 text-sm text-foreground focus:border-blue-500 outline-none transition-all font-serif"
                    >
