...
import { 
  ...
  ExternalLink, FileText, CheckCircle2, MapPin, Loader2
} from 'lucide-react';
...
export default function NGOAdministrationConsole() {
  ...
  const [colDefs] = useState<ColDef<NGORecord>[]>([
    ...
    { field: 'totalFunding', headerName: 'Capital Inflow', width: 150, valueFormatter: currencyFormatter, cellClass: 'font-bold text-foreground' },
  ]);
