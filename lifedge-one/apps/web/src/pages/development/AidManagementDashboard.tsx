        ...
        <div className="lg:col-span-1 glass-panel p-8 flex flex-col justify-between">
           <div>
              <h3 className="text-lg font-serif font-medium text-foreground flex items-center gap-3 mb-6">
                <Layers className="w-5 h-5 text-brand-gold" /> Sectoral Development Map
              </h3>
              <div className="h-[250px] relative">
                  <ResponsiveContainer width="100%" height="100%">
                     <PieChart>
                       <Pie
                         data={defaultAidBySector}
                         cx="50%"
                         cy="50%"
                         innerRadius={60}
                         outerRadius={80}
                         ...
                         stroke="none"
                       >
                         {defaultAidBySector.map((entry, index) => (
                 ...
                 <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    ...
                    <span className="text-[9px] font-black text-muted uppercase tracking-widest text-center">Infrastructure<br/>& Health</span>
                 </div>
              </div>
           </div>
