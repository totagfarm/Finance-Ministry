...
export const ALL_SECTIONS: Record<string, NavSection> = {
  ...
  payrollInterface: {
    ...
    items: [
      { label: 'Payroll Dashboard', path: '/app/pending?module=Payroll%20Dashboard' },
  ...
  debtAndFiscalRisk: {
    ...
    items: [
      ...
      { label: 'Creditor Registry', path: '/app/pending?module=Creditor%20Registry' },
      { label: 'Instrument Registry', path: '/app/finance/debt' },
      { label: 'Loan Agreements', path: '/app/pending?module=Loan%20Agreements' },
      { label: 'Debt Service Calendar', path: '/app/pending?module=Debt%20Service%20Calendar' },
      ...
      { label: 'Debt Reconciliation Bridge', path: '/app/pending?module=Debt%20Reconciliation' }
    ]
  },
  revenueIntelligence: {
    icon: TrendingUp,
  ...
  aidAndDevelopment: {
    ...
    items: [
      { label: 'Aid Dashboard', path: '/app/development/aid' },
      { label: 'Donor Registry', path: '/app/pending?module=Donor%20Registry' },
      { label: 'Donor Programs', path: '/app/pending?module=Donor%20Programs' },
      { label: 'Aid Activities', path: '/app/pending?module=Aid%20Activities' },
      { label: 'Disbursement Tracking', path: '/app/pending?module=Disbursement%20Tracking' },
      { label: 'County Investment Map', path: '/app/development/aid' },
      { label: 'Aid Reporting', path: '/app/pending?module=Aid%20Reporting' },
      { label: 'Aid Analytics', path: '/app/pending?module=Aid%20Analytics' }
    ]
  },
  ...
  ngoAccreditation: {
    ...
    items: [
      ...
      { label: 'Reviewer Queue', path: '/app/pending?module=Reviewer%20Queue' },
      { label: 'Reviewer Workspace', path: '/app/pending?module=Reviewer%20Workspace' },
      { label: 'Accreditation Decisions', path: '/app/pending?module=Accreditation%20Decisions' },
      { label: 'NGO Administration', path: '/app/development/ngo' },
      { label: 'NGO Analysis', path: '/app/pending?module=NGO%20Analysis' },
      { label: 'Status Management', path: '/app/pending?module=Status%20Management' },
      { label: 'Document Type Setup', path: '/app/pending?module=Document%20Type%20Setup' }
    ]
  },
  macOversight: {
    icon: Building2,
    ...
    items: [
      ...
      { label: 'Assets by MAC', path: '/app/pending?module=Assets%20by%20MAC' },
