  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {[
          { title: "Raise Purchase Order", desc: "Commit funds against an available allotment balance.", route: "/app/finance/execution/po-generation", icon: FileText, color: "blue-500" },
          { title: "Voucher Processing", desc: "3-way invoice matching and obligation validation.", route: "/app/finance/execution/vouchers", icon: CheckCircle, color: "brand-gold" }
        ].map((module, idx) => (
          <motion.div 
            key={idx}
